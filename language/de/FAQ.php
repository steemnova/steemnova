...
<h3>Trümmerfeld Raid:</h3>
<p>Die bequemste aber auch unbeliebteste Art Gewinn zu machen. Man klaut anderen die Trümmerfelder.
Da die Regel bei trümmerfeldern gilt, dass sie niemandem gehören und der es behalten darf, der es auch findet, sind Trümmerfeld -Klaus oftmals ein großes Ärgernis.</p>
<h3>Abfangen</h3>
...
<ul>
	...
	<li><p>Wenn ein Spieler von einen Planeten zum anderen auf Stationieren fliegt und dann abbricht, ist es in der Phalanx nichtmehr sichtbar. Doch auch hier gibt es einen Trick, wie man diese Flotte bekommt. Man beobachtet eine Zeitlang das Saveverhalten des Opfers, also wann er losfliegt und wann er abbricht. Wenn man ungefähr weiß, wann er ungefähr abbricht, setzt man sich wieder in sein System und phalanxt im Sekundentakt seinen Planeten. Wenn er abbricht und man die Flotte dann plötzlich nichtmehr in der Phalanx sieht, schaut man auf die Funkuhr, die vorhin bereits erwähnt wurde und rechnet mit dem Rückflugsimulator die Rückflugsstrecke aus, addiert sie auf die Abbruchszeit und fliegt mit seiner Flotte und Recyclern so los, dass man ca. 4-6Sekunden nach der Flotte des Opfers ankommt.</p><p>Wenn ein Spieler vom Mond aufs Trümmerfeld saved und er einen Recycler oder mehrere vorschickt, ist es fast nicht abfangbar. Es gibt jedoch einen Weg, man muss den Mond zerstören. Man schickt also einen oder mehrere Todessterne zum Mond mit dem Angriff "zerstören" (siehte Mond).</p><p>Wenn der Mond zerstört ist phalanxt man den Planeten, zu der die Flotte zurückfliegt (Wenn der Mond weg ist, fliegt Flotte automatisch zum Plani) und hängt sich wieder ein paar Sekunden hinter die Flotte des Gegners.</p><p>Es ist bei jeder dieser Techniken sehr Hilfreich, wenn man das Saveverhalten des Gegners gut kennt. Das heißt, wenn man weiß, dass er vielleicht jeden Abend um 23Uhr saved oder jeden Mittag um 12Uhr online kommt. Also vor dem Abfangen, den Gegner genau studieren.</li></ul>
BODY;

$LNG['questions'][2][2]['title']	= 'Saven';
$LNG['questions'][2][2]['body']		= <<<BODY
<h3>Wie schütze ich mich</h3>
<p>Eine große Anzahl von Verteidigungsgeschützen schreckt schon einige Spieler ab, leider werden andere dadurch angelockt, und diese kommen so oft wieder, bis man nur noch sehr wenig, oder gar nichts mehr hat. Dadurch verliert man sehr viele Ressourcen, da bei den Geschützen, nichts ins Trümmerfeld geht, wenn diese zerstört werden. Einzige Ausnahme bilden die sog. Deff-ins-Trümmerfeld-Unis, wo man aber erst recht nicht so viele Geschütze aufbaut, da man dadurch dem Angreifer die Ressourcen quasi schenkt.</p>
...
<p>Ein Mond kann entstehen wenn ein Trümmerfeld von mindestens 100.000 Units, das ist dann eine 1%ige Chance Mondchance, entsteht. Maximum sind aber nur 20% Mondchance egal wie groß das Trümmerfeld dann ist.</p>
<h3>Allgemeines</h3>
...
<h3>Mondschuss</h3>
<p>Als Mondschuss bezeichnet man das absichtliche zerstören von Schiffen um ein Trümmerfeld zu erzeugen. Meist benützt man dafür Leichte Jäger, genau 1667 damit man eine 20%ige Chance bekommt. Man benutzt LJ weil sie relativ leicht zu zerstören sind und weil sie ganz nahe an die 20% Chance dran kommen. Man muss bei Mondschüssen beachten dass wenn der Stärkere beim Schwächeren LJ zerstört nur der Schwächere das Trümmerfeld abbauen darf. Und wenn der Schwächere den Stärkeren mit zu zerstörenden Schiffen angreift dann darf wieder nur der Schwächere das Trümmerfeld abbauen, sonst wäre es Pushen.</p><p>In einem DiTF Uni ist es besser wenn man Verteidigung baut und diese dann in mehreren Wellen plätten lässt um mehrere Mondversuche nacheinander machen zu können. Dazu empfehlen sich 3334 Raketenwerfer oder 3334 Leichte Lasergeschütze.</p><p>Wenn ein Mond entstanden ist steht im KB „Die enormen Mengen an freiem Metall und Kristall ziehen sich an und formen einen Trabanten um den Planeten.</p><p>Mondwahrscheinlichkeit zwischen 1% und 19%. <br>Ein Mond kann nie größer als 8944 km im Durchmesser sein.</p>
...
<h3>Zerstörung</h3>
<p>Ein Mond kann auch wieder zerstört werden, die geht allerdings nur mit Todessternen.</p>
<p>Im Auftrags Menü wählt man statt „Angreifen“ „Zerstören“ aus. Es muss aber zuerst die auf dem Mond stehende Fleet durch den Rip zerstört werden bevor er versuchen kann den Mond zu zerstören. Die Todessterne können natürlich auch wenn sie den Kampf überstanden haben bei der Zerstörung des Monds selbst zerstört werden. Die Besonderheit bei der Mondzerstörung, es entsteht kein Trümmerfeld!</p>
<h3>Mondangriffe mit Todessternen:</h3>
<p>Die Chance auf Mondzerstörung ist „(100 - Wurzel(Mondgröße)) * Wurzel(Anzahl Todessterne)“. Die Chance, dass die zum Angriff geschickten TS beim Mondangriff zerstört werden, beträgt „Wurzel(Mondgröße) / 2“. Je größer der Mond, umso riskanter also der Versuch seiner Zerstörung.</p>
<h3>Mondchance und Mondgröße:</h3>
<p>100.000 Trümmerfeld-Einheiten ergeben 1% Mondwahrscheinlichkeit. Maximale Mondwahrscheinlichkeit: 20%. Seit einer Änderung haben alle Mondbesitzer die maximale Anzahl an bebaubaren Feldern (79) zur Verfügung. <br>
