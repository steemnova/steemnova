...
$LNG['sys_colo_notech'] 					= 'Eine deiner Flotten erreicht die Koordinaten %s. Als sich deine Siedler dem Planeten näherten, mussten sie feststellen, dass ihre Ausrüstung noch nicht für die dort herrschenden Klimabedingungen geeignet war und zuerst ASTROPHYSIK weiterentwickelt werden muss. Enttäuscht kehrten die Siedler zurück.';
...
$LNG['sys_irak_no_att'] 				  	= 'Alle Raketen des Angreifers wurden abgefangen.';
$LNG['sys_irak_def'] 					  	= '%d Raketen des Angreifers wurden abgefangen.';
$LNG['sys_irak_mess']						= 'Interplanetarraketen (%d) von %s sind auf dem Planeten %s eingeschlagen<br><br>';
$LNG['sys_fleet_won'] 						= 'Eine deiner Flotten kehrt vom Angriff auf Planeten %s %s zurück. Sie haben %s %s, %s %s und %s %s erbeutet';
