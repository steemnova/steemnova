    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                <h2 class="card-title">{$LNG.al_your_ally}</h2>
            </div>
            <div class="card-body">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>{$ally_members} / {$ally_max_members}{if $rights.MEMBERLIST} (
                                <a href="?page=alliance&amp;mode=memberList">{$LNG.al_user_list}</a>
                                ){/if}</td>
                    </tr>
                    <tr>
                        <td>{$LNG.al_rank}</td>
                        <td>{$rankName}{if $rights.ADMIN} (
                                <a href="?page=alliance&amp;mode=admin">{$LNG.al_manage_alliance}</a>
                                ){/if}</td>
                    </tr>
                    {if isModuleAvailable($smarty.const.MODULE_CHAT)}
                        <tr>
                            <td colspan="2"><a href="#" onclick="return Dialog.AllianceChat();">{$LNG.al_goto_chat}</a>
                            </td>
                        </tr>
                    {/if}
                    {if $rights.SEEAPPLY && $applyCount > 0}
                        <tr>
                            <td>{$LNG.al_requests}</td>
                            <td><a href="?page=alliance&amp;mode=admin&amp;action=mangeApply">{$requests}</a></td>
                        </tr>
                    {/if}
                    {if $rights.ROUNDMAIL}
                        <tr>
                            <td>{$LNG.al_circular_message}</td>
                            <td><a href="game.php?page=alliance&mode=circular"
                    ...
                    <tr>
                        <td colspan="2" style="height:100px"
                            class="bbcode">{if $ally_description}{$ally_description}{else}{$LNG.al_description_message}{/if}</td>
                    </tr>
                    {if $ally_web}
                        <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            {if $DiploInfo}
                                {if !empty($DiploInfo.0)}<b><u>{$LNG.al_diplo_level.0}</u></b>
                                    <br>
                                    <br>
                                    {foreach item=PaktInfo from=$DiploInfo.0}<a
                                        href="?page=alliance&mode=info&amp;id={$PaktInfo.1}">{$PaktInfo.0}</a>
                                        <br>
                                    {/foreach}
                                    <br>
                                {/if}
                                {if !empty($DiploInfo.1)}<b><u>{$LNG.al_diplo_level.1}</u></b>
                                    <br>
                                    <br>
                                    ...
                                    <br>
                                {/if}
                                {if !empty($DiploInfo.2)}<b><u>{$LNG.al_diplo_level.2}</u></b>
                                    <br>
                                    <br>
                                    ...
                                    <br>
                                {/if}
                                {if !empty($DiploInfo.3)}<b><u>{$LNG.al_diplo_level.3}</u></b>
                                    <br>
                                    <br>
                                    ...
                                    <br>
                                {/if}
                                {if !empty($DiploInfo.4)}<b><u>{$LNG.al_diplo_level.4}</u></b>
                                    <br>
                                    <br>
                    ...
                    <tr>
                        ...
                        <td>{$totalfight|number}</td>
                    </tr>
                    <tr>
                        <td>{$LNG.pl_fightwon}</td>
                        <td>{$fightwon|number} {if $totalfight}({round($fightwon / $totalfight * 100, 2)}%){/if}</td>
                    </tr>
                    <tr>
                        <td>{$LNG.pl_fightlose}</td>
                        <td>{$fightlose|number} {if $totalfight}({round($fightlose / $totalfight * 100, 2)}%){/if}</td>
                    </tr>
                    <tr>
                        <td>{$LNG.pl_fightdraw}</td>
                        <td>{$fightdraw|number} {if $totalfight}({round($fightdraw / $totalfight * 100, 2)}%){/if}</td>
                    </tr>
                    <tr>
