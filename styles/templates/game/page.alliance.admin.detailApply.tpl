...
{block name="content"}
    <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4 g-2 build-gutter">
        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">{sprintf($LNG.al_request_from,$applyDetail.username)} {$apply_time}</h2>
                </div>
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td colspan="2">{$applyDetail.name} <a href="#"
                                                                   onclick="parent.location = 'game.php?page=galaxy&galaxy={$applyDetail.galaxy}&system={$applyDetail.system}';return false;">[{$applyDetail.coordinates}
                                    ]</a></td>
                        </tr>
                        <tr>
        ...
        <div class="col">
            <form action="game.php?page=alliance&amp;mode=admin&amp;action=sendAnswerToApply&amp;id={$applyDetail.applyID}"
                  method="post">
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">{$LNG.al_reply_to_request}</h2>
                    </div>
                    <div class="card-body">

                        <table class="table table-striped">
                            <tr>
                                <td colspan="4"><textarea name="text" cols="40" rows="10" class="tinymce"
                                                          id="message"></textarea></td>
                            </tr>
                            <tr>
                                <td colspan="4">
                                    <button type="submit" name="answer" value="yes">{$LNG.al_acept_request}</button>
                                    <button type="submit" name="answer" value="no">{$LNG.al_decline_request}</button>
                                </td>
                            </tr>
                        </table>
