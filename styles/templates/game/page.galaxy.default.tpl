		...
		<div class="card">
			...
			<div class="card-body">
				<div class="btn-group btn-group-sm">
					...
					<a class="btn btn-primary btn-sm" onclick="galaxy_submit('galaxyLeft')"><i class="fas fa-arrow-left"></i></a>
					<div class="btn btn-primary btn-sm">{$galaxy}</div>
					<a class="btn btn-primary btn-sm" onclick="galaxy_submit('galaxyRight')"><i class="fas fa-arrow-right"></i></a>
				</div>

				<div class="btn-group btn-group-sm float-end">
					<div class="btn btn-secondary">{$LNG.gl_solar_system}</div>
					<a class="btn btn-secondary btn-sm" onclick="galaxy_submit('systemLeft')"><i class="fas fa-arrow-left"></i></a>
					<div class="btn btn-secondary btn-sm">{$system}</div>
					<a class="btn btn-secondary btn-sm" onclick="galaxy_submit('systemRight')"><i class="fas fa-arrow-right"></i></a>
				</div>
					...
					{for $planet=1 to $max_planets}
						<tr>
							...
							{else}
								...
								<td>
									<a class="tooltip_sticky" data-tooltip-content="{include "planet.actions.tpl"}">
								...
								<td>
									{if $currentPlanet.moon}
										<a class="tooltip_sticky" data-tooltip-content="{include "moon.actions.tpl"}">
								...
								<td>
									<a class="tooltip_sticky" data-tooltip-content="{include "user.actions.tpl"}">
