                ...
                <div class="card-body">
                    <form id="login" name="login" action="index.php?page=login" data-action="index.php?page=login"
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">{$LNG.loginUsername}</label>
                                <input type="text" class="form-control" placeholder="{$LNG.loginUsername}" id="username"
                                       name="username">
                            </div>
                            <div class="mb-3">
