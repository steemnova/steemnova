    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                <h2 class="card-title"><h2>{$LNG.siteTitleBanList}</h2>
            </div>
            <div class="card-body">
                ...
                <table>
                    ...
                    {if $banCount}
                        <tr>
                            <td style="text-align:right;" colspan="5">{$LNG.mg_page}: {if $page != 1}<a
                                    href="index.php?page=banList&amp;side={$page - 1}">
                                        &laquo;</a>&nbsp;{/if}{for $site=1 to $maxPage}<a
                                    href="index.php?page=banList&amp;side={$site}">{if $site == $page}<b>[{$site}
                                        ]</b>{else}[{$site}]{/if}
                                    </a>{if $site != $maxPage}&nbsp;{/if}{/for}{if $page != $maxPage}&nbsp;<a
                                        href="index.php?page=banList&amp;side={$page + 1}">&raquo;</a>{/if}</td>
                        </tr>
                    {/if}
                    <tr>
                        <td>{$LNG.bn_from}</td>
